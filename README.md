...
This reflects a classic problem; that if a system rewards a property, equilibrium behaviour will favor that property, even when doing so will have negative externalities. 
